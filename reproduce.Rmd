---  
title: "Reproducing the method evaluation"  
...
**Defining high-resolution fishing grounds with Automatic Identification System (AIS) data**
...
```{r code, fig.width=8, fig.height=9.5}
